...
# # What are the best activities in Barcelona? (based on a geolocation)
curl -X GET "https://test.api.amadeus.com/v1/shopping/activities/longitude=-3.69170868&latitude=40.41436995&radius=1" -H "Authorization: Bearer $ACCESS_TOKEN" -k