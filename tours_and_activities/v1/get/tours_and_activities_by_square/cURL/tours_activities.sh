...
# What are the best activities in Barcelona? (based on a square)
curl -X GET "https://test.api.amadeus.com/v1/shopping/activities/by-square?north=43.645218&west=7.182018&south=43.760768&east=7.323896" -H "Authorization: Bearer $ACCESS_TOKEN" -k