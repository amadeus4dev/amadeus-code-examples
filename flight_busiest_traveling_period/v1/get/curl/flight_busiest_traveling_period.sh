...
curl -X GET "https://test.api.amadeus.com/v1/travel/analytics/air-traffic/traveled?originCityCode=MAD&period=2017-01&direction=ARRIVING" -H "Authorization: Bearer $ACCESS_TOKEN" -k