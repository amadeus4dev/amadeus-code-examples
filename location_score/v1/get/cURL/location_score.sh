...
curl -X GET "https://test.api.amadeus.com/v1/location/analytics/category-rated-areas?latitude=41.397158&longitude=2.160873" -H "Authorization: Bearer $ACCESS_TOKEN" -k
